...
CREATE TABLE IF NOT EXISTS photos (
    ...
    original_path     TEXT NOT NULL,                              -- absolute or project-relative path
    thumbnail_path    TEXT NOT NULL,                              -- absolute or project-relative path
...
CREATE TABLE IF NOT EXISTS faces (
    ...
    photo_id          BIGINT NOT NULL REFERENCES photos(photo_id) ON DELETE CASCADE,
    xpostion        DOUBLE PRECISION NOT NULL,
    yposition        DOUBLE PRECISION NOT NULL,
    width           DOUBLE PRECISION NOT NULL,
    height          DOUBLE PRECISION NOT NULL
    -- attributes        JSONB DEFAULT '{}'::jsonb -- optional    
);
